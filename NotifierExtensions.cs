...
namespace Orchard.UI.Notify
{
    public static class NotifierExtensions
    {
        ...
        public static void Closable(this INotifier notifier, NotifyType type, LocalizedString message)
        {
        ...
        /// <param name="message">A localized message to display</param>
        /// <param name="type">The type of the notificaion.</param>
        public static void Fading(this INotifier notifier, NotifyType type, LocalizedString message)
        {
        ...
        /// <param name="message">A localized message to display</param>
        /// <param name="type">The type of the notificaion.</param>
        public static void Sticky(this INotifier notifier, NotifyType type, LocalizedString message)
        {
